...
class RiskSettings(BaseSettings):
    ...
    cooldown_consecutive_loss_mult: float = Field(0.5, env="COOLDOWN_CONSECUTIVE_LOSS_MULT")
    cooldown_high_conf_reduce_pct: float = Field(0.20, env="COOLDOWN_HIGH_CONF_REDUCE_PCT")
    cooldown_high_conf_min: float = Field(0.68, env="COOLDOWN_HIGH_CONF_MIN")
    sl_multiplier_overrides_raw: str = Field("", env="SL_MULTIPLIER_OVERRIDES")
    tp_multiplier_overrides_raw: str = Field("", env="TP_MULTIPLIER_OVERRIDES")
